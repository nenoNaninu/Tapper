...
public class App : ConsoleAppBase
{
    ...
    public async Task Transpile(
        ...
        [Option("asm", "Flag whether to extend the transpile target to the referenced assembly.")] bool includeRefarenceAssemblies = false,
        ...
        [Option("en", "PascalCase / camelCase / none (The name in C# is used as it is.)")] string enumNamingStyle = "PascalCase")
    {
        ...
        try
        {
            ...
            await TranspileCore(compilation, output, newLine, indent, includeRefarenceAssemblies, serializerOption, style, enumStyle);
    ...
    {
        var transpiler = new Transpiler(compilation, newLine, indent, includeRefarenceAssemblies, serializerOption, namingStyle, enumNamingStyle, _logger);
